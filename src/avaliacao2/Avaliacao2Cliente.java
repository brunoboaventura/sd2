 ...
 * @author bruno
 */
public class Avaliacao2Cliente extends javax.swing.JFrame {

    /**
     * Creates new form Avaliacao1Cliente
     */
    public Avaliacao2Cliente() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Avaliacao2Cliente.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Avaliacao2Cliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Avaliacao2Cliente().setVisible(true);
            }
        });
    }
